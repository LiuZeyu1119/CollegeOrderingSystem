/********************************************************************************
** Form generated from reading UI file 'userms.ui'
**
...
public:
    ...
    void setupUi(QWidget *UserMS)
    {
        if (UserMS->objectName().isEmpty())
            UserMS->setObjectName(QStringLiteral("UserMS"));
        UserMS->resize(839, 573);
        gridLayout_5 = new QGridLayout(UserMS);
        gridLayout_5->setSpacing(6);
        gridLayout_5->setContentsMargins(11, 11, 11, 11);
        gridLayout_5->setObjectName(QStringLiteral("gridLayout_5"));
        groupBox = new QGroupBox(UserMS);
...
""));
        ...
        groupBox_2 = new QGroupBox(UserMS);
...
""));
        ...
        retranslateUi(UserMS);

        QMetaObject::connectSlotsByName(UserMS);
    } // setupUi

    void retranslateUi(QWidget *UserMS)
    {
        UserMS->setWindowTitle(QApplication::translate("UserMS", "UserMS", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("UserMS", "\347\224\250\346\210\267\347\256\241\347\220\206", Q_NULLPTR));
        label->setText(QApplication::translate("UserMS", "\346\237\245\350\257\242\345\261\236\346\200\247\357\274\232", Q_NULLPTR));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("UserMS", "\345\205\250\351\203\250\347\224\250\346\210\267", Q_NULLPTR)
         << QApplication::translate("UserMS", "\350\264\246\345\217\267", Q_NULLPTR)
         << QApplication::translate("UserMS", "\350\247\222\350\211\262", Q_NULLPTR)
         << QApplication::translate("UserMS", "\346\263\250\345\206\214\346\227\266\351\227\264", Q_NULLPTR)
        );
        label_2->setText(QApplication::translate("UserMS", "\346\237\245\350\257\242\346\235\241\344\273\266\357\274\232", Q_NULLPTR));
        pb_select->setText(QApplication::translate("UserMS", "\346\237\245\350\257\242", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("UserMS", "\346\237\245\350\257\242\347\273\223\346\236\234", Q_NULLPTR));
        label_3->setText(QApplication::translate("UserMS", "\346\233\264\345\244\232\346\223\215\344\275\234", Q_NULLPTR));
        pb_delete->setText(QApplication::translate("UserMS", "\345\210\240\351\231\244", Q_NULLPTR));
        pb_insert->setText(QApplication::translate("UserMS", "\346\226\260\345\242\236", Q_NULLPTR));
        pb_save->setText(QApplication::translate("UserMS", "\344\277\235\345\255\230", Q_NULLPTR));
        pb_cancel->setText(QApplication::translate("UserMS", "\345\217\226\346\266\210", Q_NULLPTR));
        pb_update->setText(QApplication::translate("UserMS", "\344\277\256\346\224\271", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class UserMS: public Ui_UserMS {};
} // namespace Ui
