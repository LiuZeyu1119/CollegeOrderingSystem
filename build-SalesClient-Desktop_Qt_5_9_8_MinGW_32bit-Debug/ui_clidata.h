/********************************************************************************
** Form generated from reading UI file 'clidata.ui'
**
...
public:
    ...
    void setupUi(QWidget *CliData)
    {
        if (CliData->objectName().isEmpty())
            CliData->setObjectName(QStringLiteral("CliData"));
        CliData->resize(1051, 591);
        lb_head = new QLabel(CliData);
        lb_head->setObjectName(QStringLiteral("lb_head"));
        lb_head->setGeometry(QRect(180, 210, 150, 150));
        lb_head->setStyleSheet(QStringLiteral("background-color: rgb(85, 255, 255);"));
        groupBox = new QGroupBox(CliData);
...
"}"));
        ...
        pushButton = new QPushButton(CliData);
...
""));
        ...
        retranslateUi(CliData);

        QMetaObject::connectSlotsByName(CliData);
    } // setupUi

    void retranslateUi(QWidget *CliData)
    {
        CliData->setWindowTitle(QApplication::translate("CliData", "Form", Q_NULLPTR));
        lb_head->setText(QString());
        groupBox->setTitle(QApplication::translate("CliData", "\344\270\252\344\272\272\344\277\241\346\201\257", Q_NULLPTR));
        label_4->setText(QApplication::translate("CliData", "\346\263\250\345\206\214\346\227\266\351\227\264:", Q_NULLPTR));
        label->setText(QApplication::translate("CliData", "\347\224\250\346\210\267\345\220\215:", Q_NULLPTR));
        label_2->setText(QApplication::translate("CliData", "\345\247\223\345\220\215:", Q_NULLPTR));
        label_5->setText(QApplication::translate("CliData", "\346\211\200\345\234\250\345\234\260:", Q_NULLPTR));
        label_3->setText(QApplication::translate("CliData", "\350\201\224\347\263\273\347\224\265\350\257\235:", Q_NULLPTR));
        pushButton->setText(QApplication::translate("CliData", "\347\274\226\350\276\221\350\265\204\346\226\231", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class CliData: public Ui_CliData {};
} // namespace Ui
